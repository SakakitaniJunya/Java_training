...
<body>
  <%@ include file="corporator-navbar.jsp" %>
	 <div class="col-12">
		...
		<br>
		<form action="change-corporator-password" method="post">
			...
			<c:choose>
					...
					<div class="form-group row">
						<div class="mx-auto">
							...
							<button type="submit" formaction="reset-new-password-corporator" class="btn btn-primary">登録</button>
						</div>
					</div>	
					</c:when>
					<c:otherwise>		
						<div class="form-group row">
							...
							<div class="col-8">
								<input type="password" name="oldPassword" class="form-control" maxlength="30" placeholder="現在のパスワードを入力してください">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-2 head">新しいパスワード</label>
